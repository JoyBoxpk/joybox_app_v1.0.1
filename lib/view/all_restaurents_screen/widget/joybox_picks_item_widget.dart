...
import '../model/joybox_picks_widget_model.dart';

class JoyBoxPicksItemWidget extends StatelessWidget {
  const JoyBoxPicksItemWidget({
    super.key,
    required this.item,
  });

  final JoyBoxPicksWidgetModel item;
